...
const COLOR_CHANGE_MILLISECS = 1000;
const DISPLAY_COLORS = ["#F25222", "#00A4EF", "#7FBB09", "#FFB900"];

const getRandomColor = () =>
  DISPLAY_COLORS[Math.floor(Math.random() * DISPLAY_COLORS.length)];

const RenderInputColorBox = ({ color, handleOnClick }) => {
  return (
    <div
...
const buildColorList = () => () => Array(4).fill(0).map(getRandomColor);
